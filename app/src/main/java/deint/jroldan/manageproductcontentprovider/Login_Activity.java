...
import deint.jroldan.manageproductcontentprovider.presenter.LoginPresenterImpl;
...
public class Login_Activity extends AppCompatActivity implements LoginPresenter.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(((ManageProduct_Application)getApplicationContext()).getUser!=null)
            Log.d("TAG",((ManageProduct_Application)getApplicationContext()).getUser().toString());
        */
    }
