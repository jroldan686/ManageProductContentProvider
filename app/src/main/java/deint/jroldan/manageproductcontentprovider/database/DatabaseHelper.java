...
import deint.jroldan.manageproductcontentprovider.ManageProduct_Application;
import deint.jroldan.manageproductcontentprovider.provider.ManageProductContract;

public class DatabaseHelper extends SQLiteOpenHelper {

    public static final int DATABASE_VERSION = 2;
    public static final String DATABASE_NAME = "ManageProduct.deint.jroldan.manageproductcontentprovider.db";
